  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 p-8">
      <div className="max-w-4xl bg-white p-10 rounded-lg shadow-lg text-center">
        ...
        <p className="text-lg text-gray-700 mb-4">
          The app supports user registration, authentication, allowing users to manage their conversations. With Socket.io integrated, users experience real-time updates without the need to refresh, ensuring that all conversations are instantly synchronized.
        </p>
        <p className="text-lg text-gray-700 mb-4">
        ...
        <p className="text-lg text-gray-700 mb-4">
          Whether you're chatting with a single person or in a group, our platform makes it easy to stay connected and manage conversations in a way that feels natural and productive. 
        </p>
        <p className="text-lg text-gray-700">
          This assignment aims to provide a real-time, scalable, and flexible communication system that is easy to use and adapt for a variety of communication needs, making it ideal for both personal and professional use.
        </p>
      </div>
    </div>
  );
