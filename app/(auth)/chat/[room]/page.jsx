      ...
      <div className="flex-1 p-4 overflow-y-auto bg-gray-100">
        <div className="flex flex-col space-y-4">
          {messages.map((msg, index) => (
            <div key={index} className="p-2 bg-slate-300 text-gray-800 rounded shadow">
              <span className="text-blue-500 shadow p-2"><strong>{msg.username}:</strong></span> {msg.message}
